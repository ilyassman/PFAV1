...
class HomeController extends Controller
{
    ...
    public function showgererSessions()
    {
        ...
        $membres=DB::select("select inscriptions.etat,utilisateurs.*,membres.id as idmembre,nom,prenom,image from utilisateurs ,membres,inscriptions
        WHERE membres.iduser=utilisateurs.id and membres.id=inscriptions.id_membre");
