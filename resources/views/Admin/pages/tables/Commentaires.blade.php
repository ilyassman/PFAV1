              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Commentaires des membres</h3>
                  </div>
                  <div class="card-body">
                    <table
                      id="example1"
                    ...
                    >
                      ...
                      <tbody id="tablebody">
                        ...
                        <tr>
                          ...
                          <td> {{$comment->nom}} {{$comment->prenom}}</td>
                          <td>{{$comment->titre}}</td>
                          <td>
                        ...
                        @endforeach
                        <!-- Ajouter d'autres lignes pour chaque commentaire -->
                      </tbody>
                    </table>
                  </div>
                </div>
